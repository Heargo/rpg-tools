...
export const stats={
    ...
    wealth: {
        ...
        {
            return pickWeight(gauss(createArray(1,max),5)).item;
        },
    },
    //education
    education: {
    ...
    vision: {
        ...
        generate:function(max=10)
        {
            return pickWeight(gauss(createArray(0,max),9)).item;
        }
    },
    //hear
    hear: {
    ...
    communication: {
        ...
        generate:function(beauty,vision,hear,max=10)
        {
            ...
            return pickWeight(gauss(createArray(1,max),mean)).item;
        }
    },
    //luck
    luck: {
        ...
        generate:function(max=10)
        {
            return pickWeight(gauss(createArray(0,max),5)).item;
        }
    },
    //intelligence
    intelligence: {
    ...
    strength: {
        ...
        {
            return pickWeight(gauss(createArray(1,max),max-intelligence)).item;
        }
    },
    //health
    health: {
